...
def main(path):
    ...
    for cnt in contours:
        ...
        if colorCode[0] == 255 and colorCode[1] == 0 and colorCode[2] == 0:
            color = "Blue"
        elif colorCode[0] == 0 and colorCode[1] == 128 and colorCode[2] == 0:
            color = "Green"
        elif colorCode[0] == 0 and colorCode[1] == 0 and colorCode[2] == 255:
            color = "Red"
